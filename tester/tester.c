...
/*   Updated: 2025/04/23 14:33:26 by imeslaki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void simple_test12(void) {
    ...
    t_case exp[] = {
        ...
        {">", REDIR_OUT},
        {"|", PIPE},
        {"./path/file2", WORD | FILE_NAME | PATH},
    };
    assert_tokens(input, exp, COUNT(exp));
}
...
void simple_test13(void) {
    ...
    t_case exp[] = {
        {"<", REDIR_IN},
        {"\"cat\"", WORD | FILE_NAME | DOUBLE_Q},
        {"|", PIPE},
        {"echo\"test\"", WORD | CMD | DOUBLE_Q},
        {"|", PIPE},
        {"ls", WORD | CMD},
    };
    assert_tokens(input, exp, COUNT(exp));
...
void simple_test14(void) {
    ...
    t_case exp[] = {
        {"echo", WORD | CMD},
        {"'a \"b\" c'", WORD | CMD_ARG | SINGLE_Q | DOUBLE_Q},
    };
    assert_tokens(input, exp, COUNT(exp));
}
int tester(void) {
